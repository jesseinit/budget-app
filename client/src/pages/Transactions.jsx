            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="block w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2.5 pr-10 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="block w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2.5 pr-10 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-3 text-xs text-gray-500">
                              ...
                              {transaction.period_name && (
                                <>
                                  <span>•</span>
                                  <span>{transaction.period_name}</span>
                                </>
                              )}
                            </div>
                            <div className="mt-1">
                ...
                <div className="space-y-4">
                  ...
                  {selectedTransaction.category && (
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        <span className="text-gray-900">{selectedTransaction.category.name}</span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="mt-1 text-gray-900">{formatDate(selectedTransaction.transacted_at)}</p>
                    </div>
                    {selectedTransaction.period_name && (
                      <div>
                        <p className="text-sm font-medium text-gray-600">Budget Period</p>
                        <p className="mt-1 text-gray-900">{selectedTransaction.period_name}</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 font-mono text-xs text-gray-500">{selectedTransaction.id}</p>
                  </div>
